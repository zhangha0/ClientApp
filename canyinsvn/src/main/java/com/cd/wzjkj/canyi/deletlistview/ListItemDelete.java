package com.cd.wzjkj.canyi.deletlistview;
...
public class ListItemDelete extends LinearLayout {
	...
	private int deltaX;
	private int back_width;//滑动显示组件的宽�?	private float downX;
	private int itemClickMin = 5;//判断onItemClick的最大距�?	
	private float downX;
